...
payload: `artifacts/report.html`, a self-contained report, and
`artifacts/report-preview.jpg`, a 1280x720 preview. The evaluator does not
rebuild those two presentation files.
